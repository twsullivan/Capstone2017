...
/**
 * This class is responsible for accessing the folder where JSON files are
 * stored. Based on inputs from the Main class, FolderReader will read through
 * files contained in a specified folder and acquire the data specified for
 * statistics. FolderReader will take the JSON objects from the file and convert
 * them to ArrayList objects and place them in an Array.
 */
/**
 *
...
public final class FolderReader
{
    ...
    public FolderReader(String filePath, boolean verbose, boolean ignoreBlocked, boolean ignoreUnresolved, boolean ignoreNormals) throws IOException, NumberFormatException
    {
        fileList = getJSONSInDir(filePath);
    ...
    private File[] getJSONSInDir(String path) throws IOException
    {
